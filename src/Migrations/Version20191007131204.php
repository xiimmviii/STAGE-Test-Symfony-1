 ...
 */
final class Version20191007131204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP description, CHANGE galerie galerie INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD description LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE galerie galerie INT DEFAULT NULL');
    }
}
