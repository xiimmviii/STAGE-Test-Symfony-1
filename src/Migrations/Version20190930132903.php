 ...
 */
final class Version20190930132903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tarifs (id INT AUTO_INCREMENT NOT NULL, prestation VARCHAR(255) NOT NULL, tarif_jour DOUBLE PRECISION NOT NULL, tarif_nuit DOUBLE PRECISION DEFAULT NULL, tarif_weekend DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
