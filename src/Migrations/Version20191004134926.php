 ...
 */
final class Version20191004134926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD galerie INT DEFAULT NULL');
        $this->addSql('ALTER TABLE photo ADD CONSTRAINT FK_14B784189E7D1590 FOREIGN KEY (galerie) REFERENCES galerie (id)');
        $this->addSql('CREATE INDEX IDX_14B784189E7D1590 ON photo (galerie)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_14B784189E7D1590 ON photo');
        $this->addSql('ALTER TABLE photo DROP galerie');
    }
}
