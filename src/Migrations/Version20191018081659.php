 ...
 */
final class Version20191018081659 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture CHANGE filename filename VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
