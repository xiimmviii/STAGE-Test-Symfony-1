 ...
 */
final class Version20191017074350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contenu_mobile (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, date_affichage VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
